...
import { 
  ...
  RiArrowLeftLine, RiInformationLine, RiMailLine, RiPhoneLine
} from "react-icons/ri";
...
const AddJobPage = () => {
  ...
  const onSubmit = (data) => {
    ...
    showConfirm({
      title: "Confirm Post",
      message: "This will make your job listing visible to all candidates. Ready to post?",
    ...
    <div className="bg-slate-50/50 min-h-screen pt-28 pb-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">Post a New Role</h1>
          <p className="text-slate-500 mt-2 font-medium italic">Fill in the details below to find your next great hire.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="pt-4">
            <button 
              type="submit" 
              className="w-full bg-slate-900 hover:bg-slate-800 text-white font-black py-5 rounded-3xl shadow-xl shadow-slate-200 transition-all hover:-translate-y-1 active:scale-[0.98] text-lg tracking-wide uppercase"
            >
              Publish Job Listing
            </button>
            <p className="text-center text-slate-400 text-xs font-bold mt-6 uppercase tracking-widest flex items-center justify-center gap-2">
              <RiInformationLine size={14} /> You can edit or remove this listing later from your dashboard
            </p>
          </div>
        </form>
      </div>
